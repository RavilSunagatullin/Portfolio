                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group w-50">
                                        ...
                                        <select class="select2" name="tag_ids[]" multiple="multiple" data-placeholder="Select tags" id="select-tags" style="width: 100%;">
                                            @foreach($tags as $tag)
                                                <option {{is_array($post->tags->pluck('id')->toArray()) && in_array($tag->id, $post->tags->pluck('id')->toArray()) ? 'selected': ''}} value="{{$tag->id}}" class="w-50 mb-3 mt-3">{{$tag->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group w-50">
                                        ...
                                        <div class="input-group  mb-3 mt-3">
                                            <img src="{{asset('storage/'.$post->preview_image)}}" alt="{{$post->title}}" class="w-50 " style="border-radius: 8px"></img>
                                        </div>
                                    ...
                                    <div class="form-group w-50">
                                        ...
                                        <div class="input-group   mb-3 mt-3">
                                            <img src="{{asset('storage/'.$post->main_image)}}" alt="{{$post->title}}" class="w-50" style="border-radius: 8px"></img>
                                        </div>
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="previewFile"
